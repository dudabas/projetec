...
<main class="container my-5">
    ...
    <div class="col-md-6" >
        <div class="card shadow p-4" id="card-formulario">
            <h2 class="card-title mb-4" id="titulo-cadastro" >Validação</h2>
            <form>
                <p class="fs-5 fw-semibold text-center">Insira o código aqui:</p>
                <!-- Vaidacao -->
                <div class="mb-3">
                    <input type="email" class="form-control" placeholder="Código" required>
                </div>
                <!-- Botao enviar -->
                <a href="recsenhaadm_3.html" type="submit" class="btn btn-primary w-100" id="botao-cadastro">Enviar</a>
            </form>
        </div>
    </div>
</div>
